...
if [[ ${ACTION} == 'build' ]]; then
    ...
    curl -T dist/home_work-1.0.$TRAVIS_BUILD_NUMBER-amd64-bulk.deb -u $BINTRAY_USER:$BINTRAY_API_KEY "https://api.bintray.com/content/$BINTRAY_USER/projects_for_home_work/bulk/1.0/pool/b/bulk-1.0.$TRAVIS_BUILD_NUMBER-Linux.deb;deb_distribution=trusty;deb_component=main;deb_architecture=amd64;publish=1"
